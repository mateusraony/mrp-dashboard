...
export const SOURCE_REGISTRY: Record<string, SourceRegistryEntry> = {
  ...
  reddit: {
    name: 'Reddit r/Bitcoin (sentimento + ETF)',
  ...
  senticrypt: {
    name: 'SentiCrypt (sentimento de tweets)',
    url: 'https://senticrypt.com',
    free: true,
    authRequired: false,
    updateFrequency: '2h',
    staticMode: 'live',
  ...
  cryptopanic: {
    name: 'CryptoPanic (notícias + votos)',
    url: 'https://cryptopanic.com',
    free: true,
    authRequired: true,
    updateFrequency: '15min',
    limitation: 'Requer VITE_CRYPTOPANIC_KEY (chave gratuita em cryptopanic.com/developers)',
    staticMode: 'live',
    staticConfidence: 'A',
  },
  wikipedia: {
    name: 'Wikipedia Pageviews (atenção ao Bitcoin)',
    url: 'https://wikimedia.org/api/rest_v1',
    free: true,
    authRequired: false,
    updateFrequency: 'Diário (~24h lag)',
    staticMode: 'live',
    staticConfidence: 'A',
  },
  cryptocompare: {
